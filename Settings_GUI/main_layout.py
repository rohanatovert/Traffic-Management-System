...
from Interfaces.RLVD_interface import RLVD_interface
...
class MainLayout(QWidget):
    ...
    def set_configuration_layout(self):
        ...
        config_group_box = QGroupBox("YOLO Directory")
        config_group_box.setAlignment(Qt.AlignCenter)
        self.load_config_button = QPushButton("Load")
        self.load_config_button.clicked.connect(self.load_yolo_dir)
        ...
        vd_group_box = QGroupBox("Red Light Violation")
        vd_group_box.setAlignment(Qt.AlignCenter)
        self.vd_config_button = QPushButton("Load Weight File")
        self.vd_config_button.clicked.connect(self.load_rlvd)
        ...
        rrld_group_box = QGroupBox("Speed Violation")
        rrld_group_box.setAlignment(Qt.AlignCenter)
        self.rrld_config_button = QPushButton("Load Weight File")
        self.rrld_config_button.clicked.connect(self.load_speed_violation)
        ...
        self.hv_config_button = QPushButton("Load Weight File")
        self.hv_config_button.clicked.connect(self.load_helmet_violation)
        ...
        # Wrong-way Detection
        ww_group_box = QGroupBox("Lane Violation Detection")
        ww_group_box.setAlignment(Qt.AlignCenter)
        self.ww_config_button = QPushButton("Load Weight File")
        self.ww_config_button.clicked.connect(self.load_lane_violation)
        ...
        ww_group_box = QGroupBox("Speed Violation Detection")
        ww_group_box.setAlignment(Qt.AlignCenter)
        self.ww_config_button = QPushButton("Load Weight File")
        self.ww_config_button.clicked.connect(self.load_speed_violation)
        self.ww_status = QLabel("Status : Not Ready")
    ...
    def load_yolo_dir(self):
        """Load YOLO directory to target detect.py"""
        ...
        #     self.video_lineedit.setText(self.video_path)
    ...
    def start(self):
        ...
        self.vid = cv2.VideoCapture(self.video_path)
        # self.pipeline.video_recorder_init(self.video_path)
    ...
    def load_rlvd(self):
        """Load rlvd weights"""
        # self.vdi = RLVD_interface(
        #     yolo_path=self.load_yolo_dir, video_path=self.video_path
        # )
        # self.vdi.exec_()
        """Load Video From File"""
        options = QFileDialog.Options()
    ...
    def load_speed_violation(self):
        """Load Speed Violation"""
        ...
        #     self.rrl_config = self.rrli.config
        #     self.rrld_status.setText("Status : Not Ready")
        #     self.ready_status = False
        """Load Video From File"""
        options = QFileDialog.Options()
    ...
    def load_helmet_violation(self):
        ...
        #     self.hv_config = self.hvi.config
        #     self.hv_status.setText("Status : Not Ready")
        #     self.ready_status = False
        """Load Video From File"""
        options = QFileDialog.Options()
    ...
    def load_lane_violation(self):
        ...
        #     self.ww_config = self.wwi.config
    ...
    def set_image_viewer_layout(self):
        ...
        self.image = cv2.imread(r"C:\Users\rohan\Downloads\oVERT\Github\Settings GUI\img\tvdr.png")
