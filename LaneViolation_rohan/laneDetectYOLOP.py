...
def infer_yolop(img_path=r"C:\Users\rohan\Downloads\oVERT\Test\Videos\cctv.mp4"):

    ort.set_default_logger_severity(4)
    # onnx_path = f"./weights/{weight}"
    onnx_path = r"C:\Users\rohan\Downloads\oVERT\Github\LaneViolation-rohan\weights\yolop-640-640.onnx"
    ...
    save_det_path = f"detect_onnx.jpg"
    save_da_path = f"da_onnx.jpg"
    save_ll_path = f"ll_onnx.jpg"
    save_merge_path = f"output_onnx.jpg"

    # img_bgr = cv2.imread(img_path)
    img_bgr = extractBG.extract(img_path)
