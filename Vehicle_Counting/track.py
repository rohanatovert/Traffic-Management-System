...
sys.path.insert(1,r'Vehicle_Counting')
...
def detect(opt, stframe, cropimage, car, bus, truck, motor, line, fps_rate):
...
def parse_opt():
    ...
    parser.add_argument('--yolo_model', nargs='+', type=str, default=r'Vehicle_Counting\best64.pt', help='model.pt path(s)')
    ...
    parser.add_argument("--config_deepsort", type=str, default=r"Vehicle_Counting\deep_sort\configs\deep_sort.yaml")
